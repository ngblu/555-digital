            ...
            <div className="flex gap-3">
              {socialLinks.map((s) => (
                <a
                  ...
                  href={s.href}
                  aria-label={s.label}
                  className="w-9 h-9 rounded-full border border-border flex items-center justify-center text-text-muted hover:border-primary hover:text-primary transition-all duration-300"
                >
                  <s.icon />
                </a>
              ))}
